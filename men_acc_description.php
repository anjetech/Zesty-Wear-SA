...
// Fetch product details for the Men Accessories category
$sql = "SELECT id, name, description, price, image_path, size FROM product WHERE id=? AND category='Men Accessories'";
