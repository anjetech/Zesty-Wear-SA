...
// Fetch product details for the Woman Accessories category
$sql = "SELECT id, name, description, price, image_path, size FROM product WHERE id=? AND category='Woman Accessories'";
